...
const formSchema = z.object({
  ...
  vehicleId: z.string({ required_error: "Vehicle is required" }),
  driverId: z.string({ required_error: "Driver is required" }),
        ...
        <Tabs defaultValue="manual">
          ...
          <TabsContent value="upload">
            <div className="flex flex-col items-center justify-center p-10 border-2 border-dashed border-muted rounded-lg text-center min-h-[300px]">
                ...
                <p className="text-muted-foreground text-sm mb-4">Upload a .xlsx or .csv file with job details.</p>
                <Button>
