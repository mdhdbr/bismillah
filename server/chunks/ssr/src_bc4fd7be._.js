...
function CreateVehicleDialog({ isOpen, onOpenChange, onVehicleSubmit, vehicle }) {
    ...
    const title = isEditing ? "Edit Vehicle" : "Add New Vehicle";
    const description = isEditing ? "Update the details for this vehicle." : "Fill in the details to add a new vehicle to the fleet.";
...
//# sourceMappingURL=src_bc4fd7be._.js.map