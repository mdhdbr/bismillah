...
const formSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"].object({
    ...
    licenseExpiry: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"].date().optional(),
    // Vehicle fields
    ...
    registrationExpiry: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"].date().optional(),
    insuranceExpiry: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"].date().optional(),
    nextMaintenance: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"].date().optional()
});
function ComplianceDialog(param) {
            ...
            if (isOpen) {
                if (driver) {
                    ...
                    form.reset({
                        ...
                        registrationExpiry: ((_driver_vehicle3 = driver.vehicle) === null || _driver_vehicle3 === void 0 ? void 0 : _driver_vehicle3.registrationExpiry) ? new Date(driver.vehicle.registrationExpiry) : undefined,
                        insuranceExpiry: ((_driver_vehicle4 = driver.vehicle) === null || _driver_vehicle4 === void 0 ? void 0 : _driver_vehicle4.insuranceExpiry) ? new Date(driver.vehicle.insuranceExpiry) : undefined,
                        nextMaintenance: ((_driver_vehicle5 = driver.vehicle) === null || _driver_vehicle5 === void 0 ? void 0 : _driver_vehicle5.nextMaintenance) ? new Date(driver.vehicle.nextMaintenance) : undefined
                    });
                } else {
                    form.reset({
                        driverId: undefined,
    ...
    const handleFormSubmit = (values)=>{
        ...
        if (values.vehiclePlateNumber && values.vehicleType) {
            var _driver_vehicle, _driver_vehicle1, _driver_vehicle2, _driver_vehicle3, _driver_vehicle4, _values_registrationExpiry, _values_insuranceExpiry, _values_nextMaintenance;
            finalVehicle = {
                ...
                registrationExpiry: (_values_registrationExpiry = values.registrationExpiry) === null || _values_registrationExpiry === void 0 ? void 0 : _values_registrationExpiry.toISOString(),
                insuranceExpiry: (_values_insuranceExpiry = values.insuranceExpiry) === null || _values_insuranceExpiry === void 0 ? void 0 : _values_insuranceExpiry.toISOString(),
                nextMaintenance: (_values_nextMaintenance = values.nextMaintenance) === null || _values_nextMaintenance === void 0 ? void 0 : _values_nextMaintenance.toISOString()
            };
        }
        // Construct driver object
        if (isEditing) {
            var _values_licenseExpiry;
            ...
            finalDriver = {
                ...
                licenseExpiry: (_values_licenseExpiry = values.licenseExpiry) === null || _values_licenseExpiry === void 0 ? void 0 : _values_licenseExpiry.toISOString(),
                vehicleId: finalVehicle === null || finalVehicle === void 0 ? void 0 : finalVehicle.id,
                vehicle: finalVehicle
            };
        } else {
            var _values_licenseExpiry1;
            // Create new driver
            ...
            finalDriver = {
                ...
                licenseNumber: values.licenseNumber,
                licenseExpiry: (_values_licenseExpiry1 = values.licenseExpiry) === null || _values_licenseExpiry1 === void 0 ? void 0 : _values_licenseExpiry1.toISOString(),
                vehicleId: finalVehicle === null || finalVehicle === void 0 ? void 0 : finalVehicle.id,
                vehicle: finalVehicle,
                currentStatus: 'OFF_DUTY',
                fatigueLevel: 'LOW',
...
//# sourceMappingURL=src_eaeb861e._.js.map