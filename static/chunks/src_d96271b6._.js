...
function InvoicePage() {
    ...
    const [passengerRates, setPassengerRates] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(initialPassengerRates);
    const [shipperRates, setShipperRates] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(initialShipperRates);
    const [equipmentRates, setEquipmentRates] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(initialEquipmentRates);
    ...
    const handleGenerateInvoice = ()=>{
        ...
        if (!trip) {
            toast({
                variant: "destructive",
                title: "Job Not Found",
                description: "No job found with ID: ".concat(jobId)
            });
            setInvoice(null);
            return;
        }
        ...
        // --- Calculation Logic ---
        let ratePerKm = 0;
        if ((_trip_vehicle = trip.vehicle) === null || _trip_vehicle === void 0 ? void 0 : _trip_vehicle.type) {
        ...
        const generatedInvoice = {
            ...
            items: [
                ...
                {
                    id: 2,
                    description: "Fuel Surcharge (".concat((FUEL_SURCHARGE_PERCENTAGE * 100).toFixed(0), "%)"),
                    quantity: 1,
                    rate: fuelSurcharge,
...
_s(InvoicePage, "/XDtcAyXTtTJCRyLIS3eobfmS9s=", false, function() {
    return [
...
//# sourceMappingURL=src_d96271b6._.js.map