...
_s(CurrentJobCard, "V7gaCHRDUTey0kvpQGxW1KOc1xs=");
_c = CurrentJobCard;
const statusConfig = {
    // Trip Status
    PENDING: {
...
class SocketService {
    connect(userId, role) {
        ...
        console.log("Attempting to connect to socket server for user ".concat(userId, "..."));
        this.socket = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$socket$2e$io$2d$client$2f$build$2f$esm$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["io"])(SOCKET_SERVER_URL, {
            auth: {
                token
            },
        ...
        this.socket.on("connect", ()=>{
            var _this_socket;
            console.log("Socket connected with ID: ".concat((_this_socket = this.socket) === null || _this_socket === void 0 ? void 0 : _this_socket.id, " for user ").concat(this.userId));
        });
            ...
            if ((driver === null || driver === void 0 ? void 0 : driver.id) && driver.user.role) {
                ...
                const handlePing = {
                    "DriverAppClient.useEffect.handlePing": (data)=>{
                        ...
                        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$socketService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["socketService"].emit('pong', {
                            from: driver.id,
                            to: data.from
                        });
                    }
...
_s(DriverAppClient, "WdQaaUydsqHKD4ZGPSF8jStPRqs=", false, function() {
    return [
...
//# sourceMappingURL=src_c8511090._.js.map