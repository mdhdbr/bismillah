...
function SmsPageContent() {
        ...
        "SmsPageContent.useEffect": ()=>{
            ...
            if (driverId) {
                ...
                const firstUnread = conversations.find({
                    "SmsPageContent.useEffect.firstUnread": (c)=>{
                        var _c_messages_;
                        return ((_c_messages_ = c.messages[c.messages.length - 1]) === null || _c_messages_ === void 0 ? void 0 : _c_messages_.sender) === 'other';
                    }
    ...
    const handleShowAll = ()=>{
        ...
        const sortedInitial = [
            ...__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["conversations"]
        ...
        if (sortedInitial.length > 0) {
            const driverId = searchParams.get('driverId');
            if (driverId) {
                const driver = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["drivers"].find((d)=>d.id === driverId);
                const conversation = driver ? sortedInitial.find((c)=>c.contactName === driver.user.name || c.contactName === "Driver ".concat(driver.user.name)) : null;
                setSelectedConversation(conversation || sortedInitial[0]);
            } else {
                // Default to selecting the first unread conversation if available
                const firstUnread = sortedInitial.find((c)=>{
                    var _c_messages_;
                    return ((_c_messages_ = c.messages[c.messages.length - 1]) === null || _c_messages_ === void 0 ? void 0 : _c_messages_.sender) === 'other';
                });
        ...
        "SmsPageContent.useMemo[displayedConversations]": ()=>{
            if (filter === 'all') {
                ...
                return conversations.filter({
                    "SmsPageContent.useMemo[displayedConversations]": (c)=>{
                        var _c_messages_;
                        return ((_c_messages_ = c.messages[c.messages.length - 1]) === null || _c_messages_ === void 0 ? void 0 : _c_messages_.sender) === 'other';
                    }
                }["SmsPageContent.useMemo[displayedConversations]"]).sort({
                    "SmsPageContent.useMemo[displayedConversations]": (a, b)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$parseISO$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseISO"])(b.lastMessageTime).getTime() - (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$parseISO$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseISO"])(a.lastMessageTime).getTime()
                }["SmsPageContent.useMemo[displayedConversations]"]);
            }
        }
    ...
    const unreadCount = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "SmsPageContent.useMemo[unreadCount]": ()=>{
            return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["conversations"].filter({
                "SmsPageContent.useMemo[unreadCount]": (c)=>{
                    var _c_messages_;
                    return ((_c_messages_ = c.messages[c.messages.length - 1]) === null || _c_messages_ === void 0 ? void 0 : _c_messages_.sender) === 'other';
                }
                                ...
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$scroll$2d$area$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ScrollArea"], {
                                    ...
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: displayedConversations.map((conv)=>{
                                            var _conv_messages_;
                                            const isUnread = ((_conv_messages_ = conv.messages[conv.messages.length - 1]) === null || _conv_messages_ === void 0 ? void 0 : _conv_messages_.sender) === 'other';
                                            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                onClick: ()=>setSelectedConversation(conv),
                                                className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])('p-3 rounded-lg cursor-pointer transition-colors', (selectedConversation === null || selectedConversation === void 0 ? void 0 : selectedConversation.id) === conv.id ? 'bg-accent text-accent-foreground' : 'hover:bg-accent/50', isUnread && (selectedConversation === null || selectedConversation === void 0 ? void 0 : selectedConversation.id) !== conv.id && 'bg-primary/5'),
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        className: "flex items-center justify-between",
                                                        children: [
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("font-semibold", isUnread && "text-primary"),
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: [
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                                className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("text-sm truncate pr-4", isUnread ? "text-foreground font-medium" : "text-muted-foreground"),
...
_s(SmsPageContent, "NPYXcoVLvrDtzcIHfb5mMrK1vh8=", false, function() {
    return [
...
//# sourceMappingURL=src_17123937._.js.map