...
function PassengerAppClient() {
    ...
    const handleConfirmBooking = ()=>{
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["trips"].unshift(newTrip);
        toast({
            title: "Booking Submitted",
            description: "Your ride request ".concat(newTrip.jobId, " is pending assignment.")
        });
...
_s(PassengerAppClient, "hquRu92qSDJ7dBeQ+nS4+qmpP6s=", false, function() {
    return [
...
//# sourceMappingURL=src_0b64a4fe._.js.map