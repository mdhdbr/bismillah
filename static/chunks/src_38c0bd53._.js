...
function ShipperPortalClient(param) {
    ...
    const handleConfirmBooking = ()=>{
        ...
        toast({
            ...
            description: "Your booking for a ".concat(selectedVehicle.replace(/_/g, ' '), " has been confirmed.")
        });
...
_s(ShipperPortalClient, "qLKt22nRqHgSGce8qeVO+92RbYk=", false, function() {
    return [
...
//# sourceMappingURL=src_38c0bd53._.js.map