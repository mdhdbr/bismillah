...
function ManualDispatchForm() {
    ...
    const handleFindDriver = ()=>{
        ...
        addTrip(newTrip);
        router.push("/fleet/tracking?lat=".concat(pickupCoords[0], "&lng=").concat(pickupCoords[1], "&jobId=").concat(newJobId));
    };
...
_s(ManualDispatchForm, "KSwiIqbAm6bIPh/B1MAEx7c1NZg=", false, function() {
    return [
...
//# sourceMappingURL=src_9dfe76f2._.js.map