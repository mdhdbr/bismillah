...
function DashboardPage() {
    ...
    const activeTrips = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["trips"].filter((t)=>activeTripStatuses.includes(t.status)).length;
    const idleDrivers = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["drivers"].filter((d)=>d.currentStatus === "ON_DUTY" && !__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["trips"].some((t)=>t.driverId === d.id && (t.status === 'ON_ROUTE' || t.status === 'POB' || t.status === 'ON_TRIP'))).length;
    // Correctly count drivers with 'HIGH' or 'CRITICAL' fatigue levels.
    ...
    const totalMessages = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["conversations"].reduce((sum, conv)=>sum + conv.messages.length, 0);
    // --- FLEET COMPOSITION CHART LOGIC (CORRECTED) ---
    // 1. Initialize a map with all unique, normalized vehicle types from the fleet.
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["vehicles"].forEach((vehicle)=>{
        ...
        // Increment the count for each vehicle found.
    ...
    // --- DRIVER FATIGUE CHART LOGIC (CORRECTED) ---
    // 1. Define all possible fatigue levels to ensure they appear in the chart.
    ...
    // 2. Initialize a map with all fatigue levels, setting their counts to 0.
    const fatigueData = new Map(allFatigueLevels.map((level)=>[
            level,
            0
        ]));
    // 3. Iterate through all drivers and increment the count for their respective fatigue level.
    ...
    // 4. Format the data for the chart, ensuring all categories are included.
    ...
    const recentTrips = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["trips"].slice(0, 5);
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableBody"], {
                                        children: recentTrips.map((trip)=>{
                                            var _trip_vehicle, _trip_driver, _trip_distance;
                                            var _trip_distance_toFixed;
                                            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableRow"], {
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableCell"], {
                                                        children: (_trip_vehicle = trip.vehicle) === null || _trip_vehicle === void 0 ? void 0 : _trip_vehicle.plateNumber
                                                    }, void 0, false, {
                                                        fileName: "[project]/src/app/dashboard/page.tsx",
                                                        lineNumber: 233,
                                                        columnNumber: 21
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableCell"], {
                                                        children: (_trip_driver = trip.driver) === null || _trip_driver === void 0 ? void 0 : _trip_driver.user.name
                                                    }, void 0, false, {
                                                        fileName: "[project]/src/app/dashboard/page.tsx",
                                                        lineNumber: 234,
                                                        columnNumber: 21
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableCell"], {
                                                        className: "text-right",
                                                        children: [
                                                            (_trip_distance_toFixed = (_trip_distance = trip.distance) === null || _trip_distance === void 0 ? void 0 : _trip_distance.toFixed(1)) !== null && _trip_distance_toFixed !== void 0 ? _trip_distance_toFixed : 'N/A',
                                                            " km"
                                                        ]
                                                    }, void 0, true, {
                                                        fileName: "[project]/src/app/dashboard/page.tsx",
...
//# sourceMappingURL=src_8de99afc._.js.map