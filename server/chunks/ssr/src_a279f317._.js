...
(()=>{
    const e = new Error("Cannot find module './price/page'");
...
function InvoicePage() {
    ...
    const [passengerRates, setPassengerRates] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(initialPassengerRates);
    const [shipperRates, setShipperRates] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(initialShipperRates);
    const [equipmentRates, setEquipmentRates] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(initialEquipmentRates);
    ...
    const handleGenerateInvoice = ()=>{
        ...
        // This check is redundant now due to dropdown but good for robustness
        ...
        // --- Calculation Logic ---
        let ratePerKm = 0;
        if (trip.vehicle?.type) {
            const vehicleType = trip.vehicle.type;
            if (trip.type === 'PASSENGER' && passengerRates[vehicleType]) {
                ratePerKm = passengerRates[vehicleType].rate;
            } else if (trip.type === 'SHIPMENT' && shipperRates[vehicleType]) {
                ratePerKm = shipperRates[vehicleType].rate;
            } else if (trip.type === 'EQUIPMENT' && equipmentRates[vehicleType]) {
                // Note: Equipment might be hourly, but for consistency we use distance here.
                // This could be adapted if trip object stores hours.
                ratePerKm = equipmentRates[vehicleType].rate;
            }
        }
        const baseFare = ratePerKm * (trip.distance || 0);
            ...
            items: [
                {
                    ...
                    quantity: trip.distance || 0,
                    rate: ratePerKm,
                    amount: baseFare
                },
                {
                    id: 2,
                    description: `Fuel Surcharge (${(FUEL_SURCHARGE_PERCENTAGE * 100).toFixed(0)}%)`,
                    quantity: 1,
                    rate: fuelSurcharge,
...
//# sourceMappingURL=src_a279f317._.js.map