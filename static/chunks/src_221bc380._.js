...
"[project]/src/app/dashboard/invoice/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function InvoicePage() {
    ...
    const { trips, removeTrips } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$trips$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTripsStore"])();
    const [jobId, setJobId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    ...
    const invoiceRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    ...
    const getFareForTrip = (trip)=>{
        var _trip_vehicle;
        if (!((_trip_vehicle = trip.vehicle) === null || _trip_vehicle === void 0 ? void 0 : _trip_vehicle.type) || !trip.distance) return 0;
    ...
    const handleGenerateInvoice = ()=>{
        var _trip_vehicle, _trip_vehicle1;
        if (!jobId) {
            toast({
                variant: "destructive",
        ...
        if (!trip || !((_trip_vehicle = trip.vehicle) === null || _trip_vehicle === void 0 ? void 0 : _trip_vehicle.type) || !trip.distance) {
            toast({
                variant: "destructive",
                title: "Job Not Found or Incomplete",
                description: "Job with ID ".concat(jobId, " is missing required data (vehicle, distance).")
            });
            setInvoice(null);
            return;
        }
        if (trip.status !== 'COMPLETED') {
            toast({
                ...
                description: "Job ".concat(jobId, " is still in '").concat(trip.status, "' status.")
            });
            setInvoice(null);
            return;
        }
        ...
        if (!rateDetails) {
            toast({
                ...
                description: "No pricing details found for vehicle type: ".concat(vehicleType)
            });
            return;
        }
        const tripDescription = "".concat(trip.type.charAt(0) + trip.type.slice(1).toLowerCase(), " Transport - ").concat((_trip_vehicle1 = trip.vehicle) === null || _trip_vehicle1 === void 0 ? void 0 : _trip_vehicle1.type.replace(/_/g, ' '));
        ...
        const generatedInvoice = {
            ...
            items: [
                ...
                {
                    id: 2,
                    description: "Fuel Surcharge (".concat(rateDetails.per, "%)"),
                    quantity: 1,
        ...
        toast({
            ...
            description: "Invoice for Job ID ".concat(trip.jobId, " is ready.")
        });
    };
    const handlePrint = ()=>{
        window.print();
    ...
    const handleDownloadCsv = ()=>{
        ...
        const rows = invoice.items.map((item)=>[
                '"'.concat(item.description.replace(/"/g, '""'), '"'),
        ...
        rows.push([
            "VAT (".concat((VAT_RATE * 100).toFixed(0), "%)"),
            "",
            "",
        ...
        link.setAttribute("download", "".concat(invoice.id, ".csv"));
    ...
    const handleDailyArchive = ()=>{
        ...
        const rows = completedTrips.map((trip)=>{
            var _trip_vehicle, _trip_distance;
            return [
                trip.jobId,
                trip.type,
                ((_trip_vehicle = trip.vehicle) === null || _trip_vehicle === void 0 ? void 0 : _trip_vehicle.type.replace(/_/g, ' ')) || 'N/A',
                ((_trip_distance = trip.distance) === null || _trip_distance === void 0 ? void 0 : _trip_distance.toFixed(1)) || '0',
                getFareForTrip(trip).toFixed(2),
                trip.completedAt ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(new Date(trip.completedAt), 'yyyy-MM-dd HH:mm') : 'N/A'
            ];
        });
        const csvContent = "data:text/csv;charset=utf-8," + [
            headers.join(","),
        ...
        const encodedUri = encodeURI(csvContent);
        const link = document.createElement("a");
        const today = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(new Date(), 'yyyy-MM-dd');
        link.setAttribute("href", encodedUri);
        link.setAttribute("download", "".concat(today, "-invoices.csv"));
        document.body.appendChild(link);
        link.click();
        document.body.removeChild(link);
        ...
        toast({
            title: "Jobs Archived",
            description: "".concat(completedTrips.length, " completed jobs have been archived and cleared from the view.")
        });
    };
    const emailSubject = invoice ? "Invoice ".concat(invoice.id, " from MHB Logistics") : "Invoice from MHB Logistics";
    const emailBody = invoice ? "Dear ".concat(invoice.to.name, ",%0D%0A%0D%0APlease find attached your invoice ").concat(invoice.id, " for a total of ").concat(invoice.total.toFixed(2), " SAR.%0D%0A%0D%0AThank you for your business.%0D%0A%0D%0ARegards,%0D%0AMHB Logistics Billing Team") : "Please find your invoice attached.";
                                            ...
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                                    ...
                                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("a", {
                                                        href: "mailto:?subject=".concat(emailSubject, "&body=").concat(emailBody),
                                                        children: [
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Table"], {
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableBody"], {
                                        children: completedTrips.length > 0 ? completedTrips.map((trip)=>{
                                            var _trip_vehicle, _trip_distance;
                                            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableRow"], {
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableCell"], {
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableCell"], {
                                                        children: (_trip_vehicle = trip.vehicle) === null || _trip_vehicle === void 0 ? void 0 : _trip_vehicle.type.replace(/_/g, ' ')
                                                    }, void 0, false, {
                                                        fileName: "[project]/src/app/dashboard/invoice/page.tsx",
                                                        lineNumber: 476,
                                                        columnNumber: 37
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableCell"], {
                                                        className: "text-right",
                                                        children: (_trip_distance = trip.distance) === null || _trip_distance === void 0 ? void 0 : _trip_distance.toFixed(1)
                                                    }, void 0, false, {
                                                        fileName: "[project]/src/app/dashboard/invoice/page.tsx",
                                                        lineNumber: 478,
                                                        columnNumber: 37
...
_s(InvoicePage, "SMY6VwGHz+F5/jzWrCB5l/x+35w=", false, function() {
    return [
...
//# sourceMappingURL=src_221bc380._.js.map