...
function ShipperPortalClient() {
    ...
    const [bookingState, setBookingState] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("booking");
    ...
    const handleConfirmBooking = ()=>{
        ...
        // Simulate ATA being set after a delay
        setTimeout(()=>{
            setAta("16:15");
        }, 5000);
        toast({
...
_s(ShipperPortalClient, "Jv9VJM5bL9bgeD1+Tj20xQlp7Ek=", false, function() {
    return [
...
//# sourceMappingURL=src_components_4d52112f._.js.map