...
const shipperRates = {
    ...
    "TRAILER": 12.00,
    "FLATBED": 12.00,
    "CONTAINER_40FT": 15.00,
    "CONTAINER_60FT": 20.00,
    "CRANE_TRAILER": 18.00,
    "FORKLIFT": 30.00,
    "MOBILE_CRANE": 40.00,
    "BACKHOE_LOADER": 35.00,
    "BOBCAT": 25.00,
    "DUMP_TRUCK": 8.00,
    "WATER_TRUCK": 6.00
};
const FUEL_SURCHARGE_PERCENTAGE = 0.05; // 5%
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        if (distance > 0 && vehicleType) {
            ...
            if (bookingType === 'passenger') {
                ratePerKm = passengerRates[vehicleType];
            } else {
                ratePerKm = shipperRates[vehicleType];
            }
            if (ratePerKm) {
                const baseFare = ratePerKm * distance;
                const fuelSurcharge = baseFare * FUEL_SURCHARGE_PERCENTAGE;
                const subtotal = baseFare + fuelSurcharge;
...
//# sourceMappingURL=src_96871c26._.js.map