...
"[project]/src/components/forecast-button.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
function ForecastButton({ vehicle }) {
    ...
    const handleForecast = ()=>{
        ...
        startTransition(async ()=>{
            try {
                const currentTrip = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["trips"].find((t)=>t.vehicleId === vehicle.id && (t.status === 'ON_ROUTE' || t.status === 'POB'));
                if (!currentTrip) {
                    setError("Could not find a current active trip for this vehicle to forecast from.");
                    return;
                }
                const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$ai$2f$flows$2f$data$3a$728dbb__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["forecastNextTrip"])(vehicle, currentTrip);
                setResult(res);
            } catch (e) {
                                                ...
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                        children: [
                                                            ...
                                                            " ~",
                                                            result.distanceToNextPickup?.toFixed(1),
                                                            " km"
                                                        ]
                                                    }, void 0, true, {
                                                        fileName: "[project]/src/components/forecast-button.tsx",
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$forecast$2d$button$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/forecast-button.tsx [app-ssr] (ecmascript)");
"use client";
;
;
;
...
const columns = [
    ...
    },
    {
        ...
        cell: ({ row })=>{
            ...
            // Show forecast button only if vehicle is on a trip
            if (vehicle.status === "ON_TRIP") {
                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$forecast$2d$button$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ForecastButton"], {
                    vehicle: vehicle
                }, void 0, false, {
                    fileName: "[project]/src/app/dashboard/fleet/columns.tsx",
                    lineNumber: 73,
...
//# sourceMappingURL=src_5b742b5c._.js.map