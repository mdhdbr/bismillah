...
function DashboardNav(param) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("nav", {
        ...
        children: navGroups.map((group, groupIndex)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                children: [
                ...
                "WeatherMarquee.useEffect.fetchWeather": async ()=>{
                    try {
                        ...
                        for (const city of cityList){
                            const response = await fetch("https://api.open-meteo.com/v1/forecast?latitude=".concat(city.lat, "&longitude=").concat(city.lon, "&current=temperature_2m,weather_code"));
                            if (!response.ok) {
                                // If we get a non-2xx response, log it and skip to the next city.
                                console.error("Failed to fetch weather for ".concat(city.name, ": HTTP status ").concat(response.status));
                                results.push({
                                    error: true,
                                    reason: "HTTP status ".concat(response.status)
                                });
                            } else {
...
//# sourceMappingURL=src_04e8df30._.js.map