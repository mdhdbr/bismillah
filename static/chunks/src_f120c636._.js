...
const passengerVehicleTypes = [
    ...new Set(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["vehicles"].filter((v)=>v.category === "PASSENGER").map((v)=>v.type))
];
const shipperVehicleTypes = [
    ...new Set(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["vehicles"].filter((v)=>v.category === "FREIGHT" || v.category === "EQUIPMENT").map((v)=>v.type))
];
...
_s(ManualDispatchForm, "eZSmgSCFB+QkLg0a5NIhuDvRTA0=", false, function() {
    return [
...
//# sourceMappingURL=src_f120c636._.js.map